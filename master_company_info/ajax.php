...
//----------------------個別領域 ここから----------------------------
$MAIN_TABLE = "matsushima_company_info";
$MAIN_ID_FIELD = "id";

$clm_name 	= array("id","会社名","〒番号","住所","tel","fax","社長名","許可番号","銀行名","支店名","口座番号","名義名","英語名","インボイス登録番号");
$clm 		= array("id","name","postal","address","tel","fax","ceo","kyoka","bank","branch","account","meigi","eng_name","my_invoice_no");
//----------------------個別領域 ここまで----------------------------
...
//----------------------個別領域 ここから----------------------------
			echo "<td class='nw tac' style='vertical-align:middle'>";
				echo '<input type="hidden" class="chk" value="'.$row->$MAIN_ID_FIELD.'">
