 ...
 **********************************************************************/
//----------------------個別領域 ここから----------------------------
var MAIN_TABLE = "matsushima_company_info";
var MAIN_ID_FIELD = "id";
var clm 		= new Array("id","name","postal","address","tel","fax","ceo","kyoka","bank","branch","account","meigi","eng_name","my_invoice_no");
var mtitle = "■会社基本情報マスタ管理";
//----------------------個別領域 ここまで----------------------------
...
//----------------------個別領域 ここまで----------------------------
	...
	$.ajax({
		...
		cache:		false,
		url:		"ajax.php",
		data:		{parm:[flag, page, orderc,search_id,search_kw1,search_kw2]},
		type:		"post",
