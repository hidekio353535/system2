...
if( $t_fields['colmun_3'] ) {
	...
	$address_encode = urlencode(preg_replace('/　| /','',$t_fields['colmun_3']));
   	$zoom = 15;  //ズームレベル
   	$gmap_url = "http://maps.googleapis.com/maps/api/staticmap?center=".$address_encode."&markers=" .$address_encode. "&zoom=" .$zoom. "&size=640x640&sensor=false";


	$html = $css . '<h2>現場地図</h2><br /><img src="' .$gmap_url. '">';
