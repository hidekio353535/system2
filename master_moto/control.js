...
var editMode = 1;
//----------------------個別領域 ここから----------------------------
var MAIN_TABLE = "matsushima_moto";
var MAIN_ID_FIELD = "moto_id";
//----------------------個別領域 ここまで----------------------------
...
//----------------------個別領域 ここまで----------------------------
		...
		if(r) {	
			var sql = "";
//			var clm = new Array("moto", "moto_nik", "branch", "atena", "kana", "m_pat", "m_shime_group", "m_shiharai_m", "m_shiharai_day","is_stax");
//			var clm = new Array("moto", "moto_nik", "branch", "atena", "m_tantou_id", "m_tantou_sub_id", "m_address", "m_pat", "m_shime_group", "m_shiharai_m", "m_shiharai_day", "m_biko", "m_shiyo", "div_rule");
			var clm = new Array("moto", "moto_nik", "branch", "atena", "m_tantou_id", "m_address", "m_pat", "m_shime_group", "m_shiharai_m", "m_shiharai_day", "m_biko", "div_rule", "m_invoice_no","m_furikomi");
...
//----------------------個別領域 ここまで----------------------------
		...
		if(r) {	
			var sql = "";
			//var clm = new Array("moto", "moto_nik", "branch", "atena", "kana", "m_pat", "m_shime_group", "m_shiharai_m", "m_shiharai_day","is_stax");
			var clm = new Array("moto", "moto_nik", "branch", "atena", "m_tantou_id", "m_tantou_sub_id", "kana", "m_pat", "m_shime_group", "m_shiharai_m", "m_shiharai_day", "m_postal", "m_address", "m_tel", "m_fax", "m_tantou_a", "m_tantou_tel_a", "m_tantou_b", "m_tantou_tel_b", "m_tantou_c", "m_tantou_tel_c", "m_biko", "m_shiyo","m_moto_email_a","m_moto_email_b","m_moto_email_c", "div_rule", "m_invoice_no", "m_furikomi");
